...
def generate_launch_description():
    ...
    reel_server_node = Node(
       emulate_tty = True,
       package="lgs_reel_server",
       executable="reel_server_node.py",
       output="screen"
    )

    reel_image_node = Node(
       emulate_tty = True,
       package="image_tools",
    ...
    ld.add_action(reel_server_node)
    ld.add_action(reel_image_node)
    return ld
